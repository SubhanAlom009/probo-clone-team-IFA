...
export default function EventSlider() {
  return (
    <div className="max-w-full mx-auto px-4 md:px-6 lg:px-8 my-5">
      <div className="flex gap-4 overflow-x-auto no-scrollbar py-2">
        {topics.map((t, idx) => (
          <div
            key={idx}
            className="bg-white rounded-lg shadow px-4 py-2 flex items-center gap-3 cursor-pointer min-w-[220px] flex-shrink-0"
          >
            <div className="w-10 h-10 rounded-md overflow-hidden x">
              <img
                src={t.img}
                alt={t.title}
